    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full text-4xl font-bold mb-6 shadow-xl">
            📄
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-10 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button 
              type="submit" 
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-6 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-200 shadow-xl"
            >
              🚀 Acceder al Sistema
            </button>
          </form>
